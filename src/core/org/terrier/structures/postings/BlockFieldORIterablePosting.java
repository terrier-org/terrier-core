 ...
 * under the License.
 *
 * The Original Code is BlockFieldORIterablePosting.java.
 *
 ...
 */
public class BlockFieldORIterablePosting extends FieldORIterablePosting
	...
	public WritablePosting asWritablePosting() {
		return new BlockFieldPostingImpl(this.getId(), this.getFrequency(), this.getPositions(), this.getFieldFrequencies());
	}
