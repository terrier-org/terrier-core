 ...
 * under the License.
 *
 * The Original Code is BasicShakSmallChunk.java.
 *
...
public class BasicShakSmallChunk extends BasicShakespeareEndToEndTest {

	public BasicShakSmallChunk()
	{
		...
		indexingOptions.add("-Dcompression.integer.chunk.size=8");
