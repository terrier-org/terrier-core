 ...
 * under the License.
 *
 * The Original Code is BlockShak.java.
 *
...
import org.terrier.tests.BlockShakespeareEndToEndTest;

public class BlockShak extends BlockShakespeareEndToEndTest {
	...
	public BlockShak()
	{
		...
		//indexingOptions.add("-Dcompression.direct.integer.ids.codec="+ UnaryCodec.class.getName());
		...
		indexingOptions.add("-Dcompression.direct.integer.fields.codec="+ UnaryCodec.class.getName());
		//indexingOptions.add("-Dcompression.direct.integer.blocks.codec="+ UnaryCodec.class.getName());
		indexingOptions.add("-Dcompression.direct.integer.blocks.codec="+ VIntCodec.class.getName());
		...
		indexingOptions.add("-Dcompression.inverted.integer.blocks.codec="+VIntCodec.class.getName());
	}
