...
@SuiteClasses({
	...
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitByteStreams.class,
	//TestCompressedBitFiles.TestCompressedBitFiles_BitFile.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_Specific1.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_Specific3.class,	
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitFileBuffered.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitFileBufferedSmallBuffer.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitFileInMemory.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitFileInMemoryLarge.class,
	//TestCompressedBitFiles.TestCompressedBitFiles_BitFile_RandomDataInputMemory.class,
	TestCompressedBitFilesDelta.TestCompressedBitFiles_BitFileBuffered_RandomDataInputMemory.class
})

/** Ensures that Bit implementations perform as expected */
public class TestCompressedBitFilesDelta  {
	...
	public static abstract class TestCompressedBitFiles_Basic
	{
		...
		@Test public void testBit() throws Exception
		{
			...
			for(int i=0;i<testNumbers.length;i++)
			{
				...
				int number = (i %2 == 0) ? in.readDelta() : in.readUnary();
				assertEquals( ( (i %2 == 0) ? "readDelta()" : "readUnary()") + " at position "+i, testNumbers[i], number);
