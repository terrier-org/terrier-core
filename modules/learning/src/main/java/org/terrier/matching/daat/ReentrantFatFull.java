 ...
 * @since 4.0
 */
public class ReentrantFatFull extends ReentrantFull {

	static class FatMatchingState extends ReentrantFull.DAATFullMatchingState {
		boolean[] fields;
	}
	
	final int fieldCount;
	
	public ReentrantFatFull(Index index) {
		super(index);
