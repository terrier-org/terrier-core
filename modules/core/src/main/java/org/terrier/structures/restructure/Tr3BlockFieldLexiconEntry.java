...
@Deprecated
public class Tr3BlockFieldLexiconEntry extends Tr4BasicLexiconEntry implements
	...
	{	
		...
		public Factory(int _fieldCount)
		{
			...
			LoggerFactory.getLogger(Factory.class).warn(Tr3BlockFieldLexiconEntry.class.getSimpleName() + " has now been deprecated and will be removed in a future release");
		...
		public LexiconEntry newInstance() {
			return new Tr3BlockFieldLexiconEntry(fieldCount);
		}
	}	
