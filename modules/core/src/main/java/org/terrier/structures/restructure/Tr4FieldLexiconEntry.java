...
public class Tr4FieldLexiconEntry extends Tr4BasicLexiconEntry implements
	...
	{	
		...
		public LexiconEntry newInstance() {
			return new Tr4FieldLexiconEntry(fieldCount);
		}
	}	
	 ...
	 * @param fieldCount
	 */
	public Tr4FieldLexiconEntry(int fieldCount)
	{
	 ...
	 */
	public Tr4FieldLexiconEntry(int[] _fieldFrequencies)
	{
