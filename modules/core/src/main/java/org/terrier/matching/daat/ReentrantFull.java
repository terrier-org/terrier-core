...
import org.terrier.matching.BaseReentrantMatching;
 ...
 * @since 3.5
 */
public class ReentrantFull extends BaseReentrantMatching
{
	static class DAATFullMatchingState extends BaseReentrantMatching.MatchingState {
	...
	public ReentrantFull(Index index) 
	{
		super(index);
	}
