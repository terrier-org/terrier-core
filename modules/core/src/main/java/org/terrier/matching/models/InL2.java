...
/**
 * This class implements the InL2 weighting model.To control the weight of the c length normalisation parameter,
 * set the dfr.c control in the SearchRequest object.
 * @author Gianni Amati, Ben He, Vassilis Plachouras
  */
public class InL2 extends DFRNorm2BaseModel {
