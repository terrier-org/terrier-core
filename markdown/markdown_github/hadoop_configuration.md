<span>\[</span>[Previous: TREC Experiment Examples](trec_examples.html)<span>\]</span> <span>\[</span>[Contents](index.html)<span>\]</span> <span>\[</span>[Next: Hadoop MapReduce Indexing with Terrier](hadoop_indexing.html)<span>\]</span>
